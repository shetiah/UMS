...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->GradesError->Location = System::Drawing::Point(455, 367);
			this->GradesError->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->GradesError->Name = L"GradesError";
			this->GradesError->Size = System::Drawing::Size(151, 19);
			...
			this->gpaError->Location = System::Drawing::Point(455, 289);
			...
			this->HError->Location = System::Drawing::Point(455, 250);
			...
			this->AError->Location = System::Drawing::Point(455, 209);
			...
			this->pictureBox1->Click += gcnew System::EventHandler(this, &StudentDataForm::pictureBox1_Click);
			// 
			// panel2
			// 
			...
			this->grades->Location = System::Drawing::Point(-4, 367);
			this->grades->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->grades->Name = L"grades";
			this->grades->Size = System::Drawing::Size(138, 19);
			...
			this->label9->Location = System::Drawing::Point(251, 542);
			...
			this->label8->Location = System::Drawing::Point(161, 52);
			...
			this->label7->Location = System::Drawing::Point(-4, 405);
			...
			this->label6->Location = System::Drawing::Point(-4, 329);
			...
			this->label5->Location = System::Drawing::Point(-4, 289);
			...
			this->label3->Location = System::Drawing::Point(-4, 209);
			...
			this->label2->Location = System::Drawing::Point(-4, 161);
			...
			this->label1->Location = System::Drawing::Point(-4, 123);
