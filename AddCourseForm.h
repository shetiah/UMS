...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// nameTextBox
			// 
			this->nameTextBox->Location = System::Drawing::Point(85, 22);
			...
			this->label3->Location = System::Drawing::Point(34, 55);
			...
			// hoursTextBox
			// 
			this->hoursTextBox->Location = System::Drawing::Point(85, 55);
			...
			this->label4->Location = System::Drawing::Point(4, 93);
			...
			this->label6->Location = System::Drawing::Point(9, 159);
			...
			// maxStudentsTextBox
			// 
			this->maxStudentsTextBox->Location = System::Drawing::Point(85, 93);
			...
			// instructorTextBox
			// 
			this->instructorTextBox->Location = System::Drawing::Point(85, 124);
			...
			// prereqTextBox
			// 
			this->prereqTextBox->Location = System::Drawing::Point(85, 159);
			...
			this->radioButton1->Location = System::Drawing::Point(14, 48);
			...
			this->radioButton2->Location = System::Drawing::Point(14, 71);
			...
			this->label7->Location = System::Drawing::Point(11, 14);
			...
			this->label8->Location = System::Drawing::Point(38, 197);
			...
			// codeTextBox
			// 
			this->codeTextBox->Location = System::Drawing::Point(85, 197);
			...
			this->label9->Location = System::Drawing::Point(272, 301);
			...
			this->label11->Location = System::Drawing::Point(190, 95);
			...
			this->panel1->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &AddCourseForm::panel1_Paint);
			// 
			// label12
			// 
			...
			this->label12->Location = System::Drawing::Point(196, 7);
			this->label12->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label12->Name = L"label12";
			this->label12->Size = System::Drawing::Size(213, 18);
			...
			this->label13->Location = System::Drawing::Point(290, 382);
			...
			this->sidebar->Size = System::Drawing::Size(110, 375);
			...
			this->ClientSize = System::Drawing::Size(708, 402);
